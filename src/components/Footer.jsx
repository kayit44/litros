  ...
  return (
    ...
    >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <Motion.a
              ...
              style={{
                ...
                textDecoration: "none", color: "rgba(253,246,240,0.65)",
                transition: "color 0.3s",
              }}
            >
              ...
              <div>
                <div style={{ fontFamily: "'Jost', sans-serif", fontSize: "13px", fontWeight: 500, color: "var(--cream)", marginBottom: "2px" }}>
                  WhatsApp Sipariş
                </div>
                <div style={{ fontFamily: "'Jost', sans-serif", fontSize: "14px", fontWeight: 400 }}>
                  +90 532 422 42 44
                </div>
              </div>
            </Motion.a>
            ...
            {/* Konum */}
            <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", color: "rgba(253,246,240,0.65)" }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0, marginTop: "2px" }}>
              ...
              <div>
                ...
                <div style={{ fontFamily: "'Jost', sans-serif", fontSize: "14px", fontWeight: 400, lineHeight: 1.6 }}>
                  Esenler, İstanbul
                </div>
              </div>
            </div>
      ...
      >
        <p style={{
          fontFamily: "'Jost', sans-serif",
          fontSize: "13px", color: "rgba(253,246,240,0.35)",
