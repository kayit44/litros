  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {steps.map((step, i) => (
          <Motion.div
            ...
            onHoverStart={e => {
              e.target.style && (e.target.style.borderColor = "rgba(201,169,110,0.35)");
            }}
            onHoverEnd={e => {
              e.target.style && (e.target.style.borderColor = "rgba(201,169,110,0.12)");
            }}
          >
            {/* Numara */}
            <Motion.div
            ...
            <Motion.div
              animate={{ y: [0, -5, 0] }}
              transition={{
                repeat: Infinity, duration: 3 + i * 0.5,
      ...
      >
        ...
        <p style={{
          fontFamily: "'Jost', sans-serif",
          fontSize: "11px", color: "rgba(232,213,176,0.3)",
          marginTop: "16px", fontWeight: 300,
          letterSpacing: "0.5px",
        }}>
